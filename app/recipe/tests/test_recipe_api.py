...
class PrivateRecipeAPITests(TestCase):
    ...
    def setUp(self):
        self.client=APIClient()
        self.user=create_user(email='user@example.com', password='userpass123')
    ...
    def test_create_recipe_with_existing_ingredient(self):
        ...
        payload = {
            ...
            'time_minutes': 25,
            'price': '2.55',
            'ingredients': [{'name': 'Lemon'}, {'name': 'Soda'}],
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
    ...
    def test_filter_by_ingredients(self):
        ...
        r2 = create_recipe(user=self.user, title='Cauliflower Risotto')
        in1 = Ingredient.objects.create(user=self.user, name='Feta Cheese')
        in2 = Ingredient.objects.create(user=self.user, name='Cauliflower')
